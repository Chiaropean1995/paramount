...
export default function CompleteProjectCard({ id, price, image_url, title, location, description, car_park, bathroom, bedroom, room_size, onDelete }) {
    ...
    const handleUpdate = async () => {
        try {
            if (selectedProject) {
                ...
                await axios.put(`${url}/completedprojects/${id}`, updatedProjectData);
                setShowModal(false);
                ...
                <Col xs={12} md={7} className="px-0 justify-content-mobile2">
                    <div className="border p-3" style={{ height: '400px', fontFamily: "Helvetica Neue, Helvetica, Arial,Source Sans Pro, serif", backgroundColor: "#E6EFF1" }}>
                        ...
                        <div className="d-flex">
                            <p><strong><i className="fa fa-car text-muted me-3 " aria-hidden="true"></i> </strong> {car_park}</p>
                            <p><strong><i className="fa fa-bath text-muted me-3 ms-5" aria-hidden="true"></i></strong> {bathroom}</p>
                            <p><strong><i className="fa fa-bed text-muted me-3 ms-5" aria-hidden="true"></i> </strong> {bedroom}</p>
                            <p><strong><i className="fa fa-square text-muted me-3 ms-5" aria-hidden="true"></i></strong> {room_size}</p>
                            {currentUser && (
                                <div className="text-center delete-update">
                                    ...
                                    <i
                                        ...
                                        onClick={() => {
                                            setSelectedProject(completedProjects);
                                            setUpdatedProject(completedProjects);
                                            setShowModal(true);
                                        }}
